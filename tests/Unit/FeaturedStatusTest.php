...
it('returns the correct label for NotFeatured', function () {
...
it('returns the correct label for NotFeatured as boolean', function () {
    $status = FeaturedStatus::NotFeatured;
...
it('returns the correct color for NotFeatured', function () {
    $status = FeaturedStatus::NotFeatured;
    $color = $status->color();
...
it('returns the correct change button label for NotFeatured', function () {
    $status = FeaturedStatus::NotFeatured;
...
it('returns the correct change button color for NotFeatured', function () {
    $status = FeaturedStatus::NotFeatured;
