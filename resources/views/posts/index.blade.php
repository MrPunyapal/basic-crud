        ...
        <div class="flex justify-between items-center">
            ...
            <form class="mb-4" action="{{ route('posts.index') }}">
                ...
                <div class="flex items-center">
                    <input type="text" name="search" class="border border-gray-300 rounded-l-md py-2 px-4"
            ...
            <tbody>
                @forelse ($posts as $post)
                    <tr>
                        ...
                        <td class="border border-slate-600">{{ $post->category_title }}</td>
                        <td class="border border-slate-600">{{ $post->is_featured->BooleanLabel() }}</td>
                        <td class="border border-slate-600">{{ $post->created_at->format('d/m/Y H:i:s') }}</td>
                        <td class="border border-slate-600">{{ $post->updated_at->since() }}</td>
                        <td class="border border-slate-600">
